...
def test(model, test_generator, save_pth, device, filename):
    for idx in range(len(test_generator)):
        ...
        FGT_ori = resample_img(img = FGT_nii, target_affine = affine_orig, target_shape = shape_orig, interpolation = 'continuous')
        BST_ori = resample_img(img = BST_nii, target_affine = affine_orig, target_shape = shape_orig, interpolation = 'continuous')
        both_ori = resample_img(img = both_nii, target_affine = affine_orig, target_shape = shape_orig, interpolation = 'continuous')
