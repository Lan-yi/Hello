...
from vnetdata23 import Vnetdata23
...
def train(data_loader, model, optimizer, scheduler, total_epochs, save_interval, save_folder, sets):
    ...
    for epoch in range(total_epochs):
        ...
        for batch_id, batch_data in enumerate(data_loader):
            ...
            volumes, label_masks, volume_orig_affine, affine = batch_data
...
#setting
sets = parse_opts()
img_list = '../dataset/NACData_VNet_hundreds/train_3_56.txt'
batch_size = 8
num_workers = 0
pin_memory = True
epochs = 100
...
training_dataset = Vnetdata23(data_root, img_list, sets)
