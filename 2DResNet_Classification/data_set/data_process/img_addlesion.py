...
def getmaxslice_ROI(label_BST_N,label_BST_P,max,dcm2D):
    ...
    print(folder)
    output_dcm = 'D:/Study/Dataset/addlesion/' + folder + '/' + patient + '_T3_' + N + '_' + Max + '.png'    #输出地址
...
#################################
def lesion_mark(output_dcm,max,Mask):
...
lesion_mark(filename,max,label_path)
