...
#预测命令
#python predict.py --model FILE, -m CP_epoch5.pth -i SmoothIm3.2ModelInv_rot10.bmp -o data
#-i -o 后面是当前命令行目录下文件
#python predict.py --model FILE, -m checkpoints/checkpoints_random/CP_epoch5.pth -i data/random/test/images/3.2_affdown300.bmp -o data/random/test/output
#_affdown300 data/random/test/images/3.2_affup100.bmp